  ...
  return (
    <button
      ...
      className={cn(
        ...
        "ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0",
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "items-center justify-center rounded-md p-0 outline-hidden transition-transform focus-visible:ring-2",
        ...
        "group-data-[collapsible=icon]:hidden",
        showOnHover &&
          "peer-data-[active=true]/menu-button:text-sidebar-accent-foreground group-focus-within/menu-item:opacity-100 " +
